!------------------- BEGIN kppa_Serial_integrate.f90 BEGIN -------------------
! @file kppa_Serial_integrate.f90                                             
! @author charlesj                                                            
...
MODULE kppa_Serial_integrate

  USE kppa_Serial_parameters
  USE kppa_Serial_rosenbrock
...
END MODULE kppa_Serial_integrate
!--------------------- END kppa_Serial_integrate.f90 END ---------------------
