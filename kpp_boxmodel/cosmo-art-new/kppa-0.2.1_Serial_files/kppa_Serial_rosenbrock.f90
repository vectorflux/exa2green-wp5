!------------------- BEGIN kppa_Serial_rosenbrock.f90 BEGIN ------------------
! @file kppa_Serial_rosenbrock.f90                                            
! @author charlesj                                                            
! @date 2015-02-10 15:56:50.816109                                            
...
MODULE kppa_Serial_rosenbrock

  USE kppa_Serial_parameters
  USE kppa_Serial_blas
  USE kppa_Serial_rates
  USE kppa_Serial_function
  USE kppa_Serial_decomp
  USE kppa_Serial_solve
  USE kppa_Serial_jacobian
...
!-----------------------------------------------------------------------------
  SUBROUTINE Integrate(var, fix, idx, tstart, tend, abstol, reltol, idata, &
    ...
    REAL(8), INTENT(IN) :: abstol(83)
    REAL(8), INTENT(IN) :: reltol(83)
...
steploop:   DO
    ...
    slhs(3) = diag + slhs(3)
    slhs(6) = diag + slhs(6)
    slhs(14) = diag + slhs(14)
    slhs(31) = diag + slhs(31)
    slhs(43) = diag + slhs(43)
    slhs(45) = diag + slhs(45)
    slhs(47) = diag + slhs(47)
    slhs(49) = diag + slhs(49)
    slhs(53) = diag + slhs(53)
    slhs(55) = diag + slhs(55)
    slhs(58) = diag + slhs(58)
    slhs(61) = diag + slhs(61)
    slhs(64) = diag + slhs(64)
    slhs(67) = diag + slhs(67)
    slhs(71) = diag + slhs(71)
    slhs(74) = diag + slhs(74)
    slhs(78) = diag + slhs(78)
    slhs(81) = diag + slhs(81)
    slhs(83) = diag + slhs(83)
    slhs(85) = diag + slhs(85)
    slhs(87) = diag + slhs(87)
    slhs(93) = diag + slhs(93)
    slhs(105) = diag + slhs(105)
    slhs(117) = diag + slhs(117)
    slhs(126) = diag + slhs(126)
    slhs(130) = diag + slhs(130)
    slhs(134) = diag + slhs(134)
    slhs(138) = diag + slhs(138)
    slhs(142) = diag + slhs(142)
    slhs(149) = diag + slhs(149)
    slhs(153) = diag + slhs(153)
    slhs(159) = diag + slhs(159)
    slhs(163) = diag + slhs(163)
    slhs(169) = diag + slhs(169)
    slhs(175) = diag + slhs(175)
    slhs(183) = diag + slhs(183)
    slhs(187) = diag + slhs(187)
    slhs(193) = diag + slhs(193)
    slhs(201) = diag + slhs(201)
    slhs(211) = diag + slhs(211)
    slhs(221) = diag + slhs(221)
    slhs(229) = diag + slhs(229)
    slhs(248) = diag + slhs(248)
    slhs(253) = diag + slhs(253)
    slhs(257) = diag + slhs(257)
    slhs(262) = diag + slhs(262)
    slhs(269) = diag + slhs(269)
    slhs(278) = diag + slhs(278)
    slhs(288) = diag + slhs(288)
    slhs(298) = diag + slhs(298)
    slhs(307) = diag + slhs(307)
    slhs(314) = diag + slhs(314)
    slhs(320) = diag + slhs(320)
    slhs(332) = diag + slhs(332)
    slhs(345) = diag + slhs(345)
    slhs(354) = diag + slhs(354)
    slhs(366) = diag + slhs(366)
    slhs(376) = diag + slhs(376)
    slhs(391) = diag + slhs(391)
    slhs(411) = diag + slhs(411)
    slhs(425) = diag + slhs(425)
    slhs(441) = diag + slhs(441)
    slhs(475) = diag + slhs(475)
    slhs(495) = diag + slhs(495)
    slhs(525) = diag + slhs(525)
    slhs(543) = diag + slhs(543)
    slhs(552) = diag + slhs(552)
    slhs(561) = diag + slhs(561)
    slhs(574) = diag + slhs(574)
    slhs(599) = diag + slhs(599)
    slhs(617) = diag + slhs(617)
    slhs(649) = diag + slhs(649)
    slhs(695) = diag + slhs(695)
    slhs(728) = diag + slhs(728)
    slhs(782) = diag + slhs(782)
    slhs(816) = diag + slhs(816)
    slhs(842) = diag + slhs(842)
    slhs(904) = diag + slhs(904)
    slhs(923) = diag + slhs(923)
    slhs(959) = diag + slhs(959)
    slhs(977) = diag + slhs(977)
...
END MODULE kppa_Serial_rosenbrock
!--------------------- END kppa_Serial_rosenbrock.f90 END --------------------
