!------------------- BEGIN kppa_OpenMP_rosenbrock.f90 BEGIN ------------------
! @file kppa_OpenMP_rosenbrock.f90                                            
! @author charlesj                                                            
! @date 2014-12-18 14:51:39.220148                                            
...
MODULE kppa_OpenMP_rosenbrock

  USE kppa_OpenMP_parameters
  USE kppa_OpenMP_blas
  USE kppa_OpenMP_rates
  USE kppa_OpenMP_function
  USE kppa_OpenMP_decomp
  USE kppa_OpenMP_solve
  USE kppa_OpenMP_jacobian
...
END MODULE kppa_OpenMP_rosenbrock
!--------------------- END kppa_OpenMP_rosenbrock.f90 END --------------------
