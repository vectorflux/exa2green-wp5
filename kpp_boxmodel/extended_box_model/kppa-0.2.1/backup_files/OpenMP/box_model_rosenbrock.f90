...
!-----------------------------------------------------------------------------
  SUBROUTINE Integrate(var, fix, idx, tstart, tend, abstol, reltol, idata, &
    ...
    REAL(8), INTENT(IN) :: abstol(81)
    REAL(8), INTENT(IN) :: reltol(81)
...
steploop:   DO
    ...
    slhs(2) = diag + slhs(2)
    slhs(5) = diag + slhs(5)
    slhs(13) = diag + slhs(13)
    slhs(30) = diag + slhs(30)
    slhs(42) = diag + slhs(42)
    slhs(44) = diag + slhs(44)
    slhs(46) = diag + slhs(46)
    slhs(48) = diag + slhs(48)
    slhs(52) = diag + slhs(52)
    slhs(54) = diag + slhs(54)
    slhs(57) = diag + slhs(57)
    slhs(60) = diag + slhs(60)
    slhs(63) = diag + slhs(63)
    slhs(65) = diag + slhs(65)
    slhs(69) = diag + slhs(69)
    slhs(74) = diag + slhs(74)
    slhs(77) = diag + slhs(77)
    slhs(79) = diag + slhs(79)
    slhs(81) = diag + slhs(81)
    slhs(83) = diag + slhs(83)
    slhs(89) = diag + slhs(89)
    slhs(101) = diag + slhs(101)
    slhs(113) = diag + slhs(113)
    ...
    slhs(266) = diag + slhs(266)
    slhs(274) = diag + slhs(274)
    slhs(284) = diag + slhs(284)
    slhs(294) = diag + slhs(294)
    slhs(303) = diag + slhs(303)
    slhs(310) = diag + slhs(310)
    slhs(316) = diag + slhs(316)
    slhs(328) = diag + slhs(328)
    slhs(341) = diag + slhs(341)
    slhs(351) = diag + slhs(351)
    slhs(363) = diag + slhs(363)
    slhs(373) = diag + slhs(373)
    slhs(388) = diag + slhs(388)
    slhs(408) = diag + slhs(408)
    slhs(422) = diag + slhs(422)
    slhs(438) = diag + slhs(438)
    slhs(472) = diag + slhs(472)
    slhs(492) = diag + slhs(492)
    slhs(501) = diag + slhs(501)
    slhs(531) = diag + slhs(531)
    slhs(548) = diag + slhs(548)
    slhs(557) = diag + slhs(557)
    slhs(571) = diag + slhs(571)
    slhs(597) = diag + slhs(597)
    slhs(614) = diag + slhs(614)
    slhs(649) = diag + slhs(649)
    slhs(710) = diag + slhs(710)
    slhs(728) = diag + slhs(728)
    slhs(747) = diag + slhs(747)
    slhs(793) = diag + slhs(793)
    slhs(827) = diag + slhs(827)
    slhs(852) = diag + slhs(852)
    slhs(885) = diag + slhs(885)
    slhs(938) = diag + slhs(938)
    slhs(972) = diag + slhs(972)
