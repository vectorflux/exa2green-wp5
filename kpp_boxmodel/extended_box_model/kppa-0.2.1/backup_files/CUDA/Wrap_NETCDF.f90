MODULE Wrap_NETCDF
  ...
  INTEGER, PARAMETER :: lookup(n_from_file-1)=(/ &
       ! lookup table for the variable species read from the *nc files and being updated at every hour in data_kpp
       41,76,78,35,44,   77,17, &
       63, 8,43,80,73, 2,70,28, &
       59,26, 3, 4,27,81,33,20, &
       10,14,36,42,68,18,19,72, &
       11,12,32,54,46,62,50,74, &
       30,40,45,31, 9,38,49,15, &
       29,21, 5,22,23,24,16,13, &
       66 /)       
...
CONTAINS
  ...
  SUBROUTINE ShuffleFromFile2KPP(V, V_from_file)
    ...
    REAL, INTENT(out) :: V(ntot-1) ! V - Concentrations of variable species (local)
    REAL, INTENT(in)  :: V_from_file(ntot) ! V_USER - Concentration of variable species in USER's order
    
    V(1) = V_from_file(61) !N2
    V(2) = V_from_file(14) !SULF
    V(3) = V_from_file(19) !ORA1
    V(4) = V_from_file(20) !ORA2
    V(5) = V_from_file(51) !CS1
    V(6) = V_from_file(58) !CO2
    V(7) = V_from_file(59) !H2
    V(8) = V_from_file(10) !ETH
    V(9) = V_from_file(45) !ISHP
    V(10) = V_from_file(25) !HC5
    V(11) = V_from_file(33) !TPAN
    V(12) = V_from_file(34) !HONO 
    V(13) = V_from_file(56) !DMSO
    V(14) = V_from_file(26) !HC8
    V(15) = V_from_file(48) !MAHP
    V(16) = V_from_file(55) !DMS
    V(17) = V_from_file( 8) !SO2
    V(18) = V_from_file(30) !TOL
    V(19) = V_from_file(31) !XYL
    V(20) = V_from_file(24) !HC3
    V(21) = V_from_file(50) !NALD
    V(22) = V_from_file(52) !CS10
    V(23) = V_from_file(53) !CS100
    V(24) = V_from_file(54) !CS1000
    V(25) = V_from_file(66) !O1D
    V(26) = V_from_file(18) !PAA
    V(27) = V_from_file(21) !N2O5
    V(28) = V_from_file(16) !OP1
    V(29) = V_from_file(49) !MPAN
    V(30) = V_from_file(41) !CSL
    V(31) = V_from_file(44) !HACE
    V(32) = V_from_file(35) !HNO4
    V(33) = V_from_file(23) !PAN
    V(34) = V_from_file(68) !O3P
    V(35) = V_from_file(4 ) !H2O2
    V(36) = V_from_file(27) !OL2
    V(37) = V_from_file(66) !ISOP
    V(38) = V_from_file(46) !ISON
    V(39) = V_from_file(60) !O2
    V(40) = V_from_file(42) !API
    V(41) = V_from_file(1 ) !CO
    V(42) = V_from_file(28) !OLT
    V(43) = V_from_file(11) !ISO
    V(44) = V_from_file(5 ) !HNO3
    V(45) = V_from_file(43) !LIM
    V(46) = V_from_file(37) !GLY
    V(47) = V_from_file(81) !XNO2
    V(48) = V_from_file(77) !XYLP
    V(49) = V_from_file(47) !MACR
    V(50) = V_from_file(39) !DCB
    V(51) = V_from_file(71) !HC5P
    V(52) = V_from_file(72) !HC8P
    V(53) = V_from_file(75) !OLIP
    V(54) = V_from_file(36) !KET
    V(55) = V_from_file(73) !OL2P
    V(56) = V_from_file(74) !OLTP
    V(57) = V_from_file(80) !XO2
    V(58) = V_from_file(76) !TOLP
    V(59) = V_from_file(17) !OP2
    V(60) = V_from_file(65) !MACP
    V(61) = V_from_file(64) !OLN
    V(62) = V_from_file(38) !MGLY
    V(63) = V_from_file(9 ) !HCHO
    V(64) = V_from_file(69) !TCO3
    V(65) = V_from_file(82) !APIP
    V(66) = V_from_file(57) !H2O
    V(67) = V_from_file(83) !LIMP
    V(68) = V_from_file(29) !OLI
    V(69) = V_from_file(78) !ETHP
    V(70) = V_from_file(15) !ALD
    V(71) = V_from_file(79) !KETP
    V(72) = V_from_file(32) !ACO3
    V(73) = V_from_file(13) !HO
    V(74) = V_from_file(40) !ONIT
    V(75) = V_from_file(70) !HC3P
    V(76) = V_from_file(2 ) !NO2
    V(77) = V_from_file(7 ) !NO
    V(78) = V_from_file(3 ) !O3
    V(79) = V_from_file(63) !MO2
    V(80) = V_from_file(12) !HO2
    V(81) = V_from_file(22) !NO3
    V(82) = V_from_file(62) !CH4  
...
SUBROUTINE Get_Boxes(data_kpp, local_temperature, act_hour)
  ...
  REAL, INTENT(out) :: data_kpp(idim,jdim,kdim,ntot-1)
