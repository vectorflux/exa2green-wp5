...
! @author jlinford                                                            
! @date 2014-06-03 14:55:30.941975                                            
...
! BEGIN INLINE declared at /Users/jlinford/workspace/kppa/verify/box_model/box_model.def:325,1 
...
! END INLINE declared at /Users/jlinford/workspace/kppa/verify/box_model/box_model.def:325,1 
...
!-----------------------------------------------------------------------------
  SUBROUTINE Rates(time, idx, rct)
    ...
    rct(3) = PHUX(5.36E-04,0.34764E+00,0.91030E+00)
    rct(4) = PHUX(8.96E-04,0.99438E+00,0.83295E+00)
    rct(5) = PHUX(5.48E-07,2.86922E+00,0.79561E+00)
    rct(6) = PHUX(3.90E-06,2.37354E+00,0.79830E+00)+EQT2(TEMP)
    rct(7) = PHUX(2.74E-02,0.26226E+00,0.92849E+00)
    rct(8) = PHUX(2.73E-01,0.29327E+00,0.92401E+00)
    rct(9) = PHUX(7.78E-06,1.91463E+00,0.79810E+00)
    rct(10) = PHUX(4.92E-05,1.60973E+00,0.80184E+00)
    rct(11) = PHUX(4.05E-05,2.06917E+00,0.80267E+00)
    rct(12) = PHUX(5.40E-06,2.52915E+00,0.79722E+00)
    rct(13) = PHUX(6.37E-06,1.76570E+00,0.80004E+00)
    rct(14) = PHUX(6.37E-06,1.76570E+00,0.80004E+00)
    rct(15) = PHUX(6.10E-09,9.17009E+00,0.72585E+00)
    rct(16) = PHUX(1.32E-05,2.46350E+00,0.79768E+00)
    rct(17) = PHUX(3.11E-03,0.55016E+00,0.88313E+00)
    rct(18) = PHUX(3.11E-03,0.55016E+00,0.88313E+00)
    rct(19) = PHUX(1.85E-03,0.57967E+00,0.87921E+00)
    rct(20) = PHUX(6.39E-04,1.53712E+00,0.80233E+00)
    rct(21) = PHUX(7.20E-08,9.11436E+00,0.72600E+00)
