!---------------------- BEGIN small_rosenbrock.f90 BEGIN ---------------------
! @file small_rosenbrock.f90                                                  
! @author jlinford                                                            
! @date 2014-06-01 10:26:33.283291                                            
...
MODULE small_rosenbrock
  ...
  IMPLICIT NONE
    ...
    ! Machine epsilon
    REAL(8), PARAMETER :: REAL_EPSILON = 2.2204460492503131d-016 !EPSILON(REAL(1.0D0))

    ! Minimum time delta
    REAL(8), PARAMETER :: MIN_DELT = 1.0d-5 !10.0 * REAL_EPSILON
...
!-----------------------------------------------------------------------------
  SUBROUTINE Integrate(var, fix, idx, tstart, tend, abstol, reltol, idata, &
    ...
    REAL(8), INTENT(IN) :: abstol(5)
    REAL(8), INTENT(IN) :: reltol(5)
...
steploop:   DO
                ...
                CALL RosenStageLHS(1.0d0/(dir*H*gam(1)), jac0, slhs)
...
END MODULE small_rosenbrock
!------------------------ END small_rosenbrock.f90 END -----------------------
