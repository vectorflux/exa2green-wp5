!---------------------- BEGIN small_integrate.f90 BEGIN ----------------------
! @file small_integrate.f90                                                   
! @author jlinford                                                            
! @date 2014-06-01 10:26:33.291414                                            
...
MODULE small_integrate

  USE small_parameters
  USE small_rosenbrock
...
END MODULE small_integrate
!------------------------ END small_integrate.f90 END ------------------------
