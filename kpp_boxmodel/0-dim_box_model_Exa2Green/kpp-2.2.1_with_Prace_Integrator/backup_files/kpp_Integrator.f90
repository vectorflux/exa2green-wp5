...
! Time                 : Wed Nov 26 17:31:37 2014
! Working directory    : /users/charlesj/KPP_BOXMODEL/0-dim_box_model_Exa2Green/kpp-2.2.1_with_Prace_Integrator
...
!  USE kpp_Parameters, ONLY: NVAR, NFIX, NSPEC, LU_NONZERO
  USE kpp_Parameters, ONLY: NVAR, NFIX, NSPEC, LU_NONZERO, &
       ...
       idim_loc_e, jdim_loc_e, kdim_loc_e, NREACT
...
SUBROUTINE INTEGRATE( TIN, TOUT, &
  ICNTRL_U, RCNTRL_U, ISTATUS_U, RSTATUS_U, IERR_U )
   ...
   INTEGER       :: ICNTRL(20), ISTATUS(20), IERR, ii, jj, kk
...
!~~~>  Arguments
   ...
   REAL(kind=dp), INTENT(INOUT)    :: AbsTol(N),RelTol(N) ! MZ_CY
...
!~~~>  Local variables
   ...
   REAL(kind=dp) :: kk, bb, thres_tau ! MZ_CY
   LOGICAL  :: l_H211b
...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
USE kpp_Function, ONLY: Fun_Split
...
!~~~> Input: integration parameters
   ...
   REAL(kind=dp), INTENT(INOUT) :: Hstart, Hmin, Hmax
   INTEGER, INTENT(IN) :: Max_no_steps
   REAL(kind=dp), INTENT(IN) :: Roundoff, FacMin, FacMax, FacRej, FacSafe
   REAL(kind=dp), INTENT(IN) :: kk, bb, thres_tau ! MZ_CY
...
!MZ_CY+
   REAL(kind=dp) :: P(N), L(N), LC(N), Iqssa(N), Css(N), Y0(N), Y1(N), Y2(N), Y3(N) ! Production rate, Destruction frequency and Concentration at steady state 
   REAL(kind=dp) :: tlife(N), tau_qssa(N), tau_qssa_max, t_ind(N), t_ind_max
...
!MZ_CY-
   ...
   REAL(kind=dp) :: ErrOld, FacOld, Ymax ! MZ_CY
