...
/* @author charlesj                                                            */
/* @date 2014-10-30 17:04:39.049060                                            */
...
/* BEGIN INLINE declared at /users/charlesj/KPP_BOXMODEL/0-dim_box_model_Exa2Green/kppa-0.2.1/box_model.def:323,1 */
...
/* END INLINE declared at /users/charlesj/KPP_BOXMODEL/0-dim_box_model_Exa2Green/kppa-0.2.1/box_model.def:323,1 */
...
void Rates(size_t const ncells32, double const time, size_t const idx,
    double* d_rct, double CHI)
{
    size_t nBlocks = ((ncells32 + 127) & ~127) >> 7;
    size_t nThreads = 128;
    d_Rates<<<nBlocks, nThreads>>>(ncells32, time, idx, d_rct, CHI);
}/* END Rates */
