...
!-----------------------------------------------------------------------------
  ...
  REAL(8), PARAMETER :: TEMP = 284.283508
...
!-----------------------------------------------------------------------------
! Reference solution obtained from a previous reference run of 1h 
! on Piz Daint with KPP-2.2.3, Ros4, rtol = atol = 0.01
!-----------------------------------------------------------------------------

  REAL(8), PARAMETER :: ref_sol(8) = &
       (/0.3021344182219022E-02, & ! OP1
       0.3228304459890887E-01, &   ! H2O2
       0.1128553136589698E+01, &   ! HCHO
       0.1694898875344983E+00, &   ! NO2
       0.9999586579399654E+01, &   ! NO
       0.1120728019129144E+00, &   ! O3
       0.2948159879001965E-06, &   ! NO3
       0.3716405898891010E-03/)    ! HO
