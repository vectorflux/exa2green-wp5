...
! ****************************************************************
      ...
      WRITE(10,999) (TIME-TSTART)/(TEND-TSTART)*100, (VARTOT(LOOKAT(i),idim_spot,jdim_spot,kdim_spot)/CFACTOR, i=1,NLOOKAT)
999   FORMAT(F6.1,100(1X,E24.16))
