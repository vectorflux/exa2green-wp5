...
OpenMPI 1.6.5, the communication library tested in \tinto, features two operation modes, 
blocking and modes, which can be selected when the application is launched.
