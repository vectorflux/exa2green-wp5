...
\title{Evaluating the performance and energy efficiency of COSMO-ART
  atmospheric model \thanks{Grants or other notes about the article
    that should go on the front page should be placed here.}  }
...
\institute{Dr. Joseph Charles \at Swiss National Supercomputing Centre
  ...
  \\ \email{joseph.charles@cscs.ch} \\ \\
% \\ \emph{Present address:} of F. Author % if needed \and
...
\begin{abstract}
We evaluate the energy-to-solution of COSMO-ART atmospheric
model. \keywords{High performance computing \and Energy-aware
  computing \and Numerical Weather Prediction}
