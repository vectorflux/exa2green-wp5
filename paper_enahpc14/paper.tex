...
%
\def\plusNoSpace{\texttt{+}}
\def\plus{\texttt{+}\xspace}
\def\minusNoSpace{\texttt{-}}
\def\minus{\texttt{-}\xspace}
\def\cpp{C{}\plusNoSpace\plusNoSpace\xspace}

\begin{document}

\title{Evaluating the Performance  and Energy Efficiency of COSMO-ART,
  a Coupled Numerical Weather Forecast and Chemical Transport Model\thanks{IBM, the IBM~logo, ibm.com, and Blue~Gene/Q are trademarks or registered trademarks of International Business Machines Corporation in the United~States, other countries, or both.}}
...
\author{Joseph~Charles \and William~Sawyer \and Manuel~F.~Dolz \and
  Sandra~Catal\'an \and A.~Cristiano~I.~Malossi \and Costas~Bekas}
...
\institute{J.~Charles, W.~Sawyer
	...
	\\ ES-12071 Castell\'on, Spain
        ...
        \and A.~C.~I.~Malossi, C.~Bekas
        \at IBM Research -- Zurich
        \\ CH-8803 R\"uschlikon, Switzerland
        \\ E-mails:~{\{acm,bek\}@zurich.ibm.com}
}
...
\begin{abstract}
  In  this paper  we present  the energy-to-solution  of  COSMO-ART on
  various platforms.   This model is  an extension of  the operational
  ...
  code    sections   to    sustain   performance    while   minimizing
...
\section{HPC Supercomputers}
\label{sec:5}
\input{Sec5:Supercomputers.tex}

\section{Power-performance measurement framework}
\label{sec:3}
\input{Sec3:Measurement-framework.tex}
