...
Power saving mechanisms enabled on all the nodes' platforms are the C-states (C1, C3 and C6) 
and P-states, but only P0 or the maximum frequency is used. TurboBoost feature is also enabled for our experiments.
