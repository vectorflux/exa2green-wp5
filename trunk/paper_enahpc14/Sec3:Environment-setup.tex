...
\item \monch is  a 10-rack NEC-provided clus\-ter at  CSCS composed by
  ...
  % and  utilised  by  members  of  the  Swiss  Platform  for  Advanced
  % Scientific Computing (PASC) project~\cite{PASC}.  
Each standard  compute node  is comprised of  two Intel Ivy  Bridge EP
...
SX6036 and FDR switches.  For our experiments, a full rack constituted
