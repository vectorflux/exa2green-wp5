...
\begin{abstract}
  ...
  the basis of broader  considerations to tackle challenges related to
  energy efficient high performance  computing in the framework of the
...
\section{COSMO coupled with ART extension}
\label{sec:1}
