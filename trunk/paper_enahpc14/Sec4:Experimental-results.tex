...
Averaged TTS and ETS results  over 10 repetitions of 24-hour simulation on
...
\begin{figure}[htbf]
  ...
  \caption{Time-to-solution and  energy-to-solution comparison between
    \pilat and \monch for a 24-hour simulation.}
  \label{fig:3}
\end{figure}
...
\begin{figure}[htbf]
  ...
  \caption{Mean time-to-solution and  energy-to-solution on \tinto for
    a 24-hour simulation using the  \emph{aggressive} and \emph{degraded} MPI policies. The
...
\begin{figure*}[ht]
  ...
  \caption{24-hour simulation power  trace  using  the \emph{aggressive}  and
