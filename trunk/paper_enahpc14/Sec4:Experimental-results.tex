...
The TTS and ETS results for a full-day simulation on \tinto are shown in Figure~\ref{fig:4}.  
...
% For all the experiments we also analyse the contribution of the MPI library to the energy 
