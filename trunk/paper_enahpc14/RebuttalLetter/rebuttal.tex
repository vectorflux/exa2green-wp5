...
Now we have replaced them to ``aggressive'' and ``degraded'', since reflects exactly the experiments of our paper. 
For the second comment, the reviewer is completely right on that issue, however even with  the ``degraded'' policy 
the CPU utilization is reduced to 50\,\% and thus allows us to save energy.
\end{weSay}
...
%%% *** Joseph ***
\begin{weSay}
We have fixed the sentence accordingly to avoid any confusion.
\end{weSay}
