...
int V, F, VAR, FIX;
int RCONST, RCT;
int RCONST_PREV, RCONST_DT, PERIOD, I_DO_LIN_INTERP; /*cy_gf_20121129*/
...
/*cy_gf_20121129+*/
  PERIOD = DefElm( "PERIOD", real, "Integration period ! cy_gf_20121129");
  RCONST_PREV = DefvElm( "RCONST_PREV", real, -NREACT, "Rate constants of previous step (T=0) !cy_gf_20121129" );
  RCONST_DT = DefvElm( "RCONST_DT", real, -NREACT, "Rate constants at the end of period (T=period) !cy_gf_20121129+" );
  I_DO_LIN_INTERP=DefElm( "I_DO_LIN_INTERP", INT, "if >1 do lin_interpolation this time step ! cy_gf_20121129");
/*cy_gf_20121129-*/
...
int dim;
  ...
  GlobalDeclare( DT );
/*cy_gf_20121129+*/
  GlobalDeclare( PERIOD );
  GlobalDeclare( RCONST_PREV );
  GlobalDeclare( RCONST_DT );
  GlobalDeclare( I_DO_LIN_INTERP);
/*cy_gf_20121129-*/
  GlobalDeclare( ATOL );
  GlobalDeclare( RTOL );
...
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
// Adapted from Prace WP8 to facilitate rosenbrock_posdef_h211b_qssa solver in KPP-2.2.1
...
int mxyz;
 ...
 /* ExternDeclare( C_DEFAULT ); */
  ...
  ExternDeclare( DT );
/*cy_gf_20121129+*/
  ExternDeclare( RCONST_PREV );
  ExternDeclare( RCONST_DT );
  ExternDeclare( PERIOD );
  ExternDeclare( I_DO_LIN_INTERP );
/*cy_gf_20121129-*/
  ExternDeclare( ATOL );
  ExternDeclare( RTOL );
...
/*  }*/
  ...
  // Adapted from Prace WP8 to facilitate rosenbrock_posdef_h211b_qssa solver in KPP-2.2.1
  printf("\nKPP is generating the ODE function split:");
  printf("\n    - %s_Function_Split",rootFileName);
  GenerateFun_Split(); 
