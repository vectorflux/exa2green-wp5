...
! @author jlinford                                                            
! @date 2014-06-03 14:55:36.203267                                            
...
steploop:   DO
    ...
    slhs(50) = diag + slhs(50)
    slhs(54) = diag + slhs(54)
    slhs(56) = diag + slhs(56)
    slhs(59) = diag + slhs(59)
    slhs(62) = diag + slhs(62)
    slhs(64) = diag + slhs(64)
    slhs(68) = diag + slhs(68)
    slhs(73) = diag + slhs(73)
    slhs(76) = diag + slhs(76)
    slhs(78) = diag + slhs(78)
    slhs(80) = diag + slhs(80)
    slhs(82) = diag + slhs(82)
    slhs(88) = diag + slhs(88)
    slhs(100) = diag + slhs(100)
    slhs(112) = diag + slhs(112)
    slhs(121) = diag + slhs(121)
    slhs(125) = diag + slhs(125)
    slhs(129) = diag + slhs(129)
    slhs(133) = diag + slhs(133)
    slhs(137) = diag + slhs(137)
    slhs(143) = diag + slhs(143)
    slhs(147) = diag + slhs(147)
    slhs(153) = diag + slhs(153)
    slhs(157) = diag + slhs(157)
    slhs(163) = diag + slhs(163)
    slhs(169) = diag + slhs(169)
    slhs(177) = diag + slhs(177)
    slhs(181) = diag + slhs(181)
    slhs(187) = diag + slhs(187)
    slhs(195) = diag + slhs(195)
    slhs(203) = diag + slhs(203)
    slhs(211) = diag + slhs(211)
    slhs(230) = diag + slhs(230)
    slhs(235) = diag + slhs(235)
    slhs(241) = diag + slhs(241)
    ...
    slhs(350) = diag + slhs(350)
    slhs(362) = diag + slhs(362)
    slhs(372) = diag + slhs(372)
    slhs(387) = diag + slhs(387)
    slhs(407) = diag + slhs(407)
    slhs(421) = diag + slhs(421)
    slhs(437) = diag + slhs(437)
    slhs(471) = diag + slhs(471)
    slhs(491) = diag + slhs(491)
    slhs(500) = diag + slhs(500)
    slhs(530) = diag + slhs(530)
    slhs(547) = diag + slhs(547)
    slhs(556) = diag + slhs(556)
    slhs(570) = diag + slhs(570)
    slhs(596) = diag + slhs(596)
    slhs(613) = diag + slhs(613)
    slhs(673) = diag + slhs(673)
    slhs(692) = diag + slhs(692)
    slhs(710) = diag + slhs(710)
    slhs(763) = diag + slhs(763)
    slhs(809) = diag + slhs(809)
    slhs(843) = diag + slhs(843)
    slhs(868) = diag + slhs(868)
    slhs(901) = diag + slhs(901)
    slhs(935) = diag + slhs(935)
    slhs(971) = diag + slhs(971)
