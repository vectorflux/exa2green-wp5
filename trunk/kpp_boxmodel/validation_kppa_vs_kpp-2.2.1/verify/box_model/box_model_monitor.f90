!--------------------- BEGIN box_model_monitor.f90 BEGIN ---------------------
! @file box_model_monitor.f90                                                 
! @author jlinford                                                            
! @date 2014-06-03 14:55:36.316311                                            
...
!-----------------------------------------------------------------------------
  ...
  INTEGER, PARAMETER :: ILOOKAT(NLOOKAT) = (/ 35, 72, 76, 77, 80 /)

  ! Indicies of species concentrations sent to screen 
  INTEGER, PARAMETER :: IMONITOR(NMONITOR) = (/ 35, 72, 76, 77, 80 /)
