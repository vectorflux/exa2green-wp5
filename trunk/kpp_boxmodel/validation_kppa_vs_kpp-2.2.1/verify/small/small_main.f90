!------------------------- BEGIN small_main.f90 BEGIN ------------------------
! @file small_main.f90                                                        
! @author jlinford                                                            
! @date 2014-06-01 10:26:33.355874                                            
...
PROGRAM main
    ...
    USE small_integrate
    USE small_initialize
    USE small_driver_parameters
    USE small_monitor
    ...
    CHARACTER(80), PARAMETER :: fname = "small.dat"
...
101 FORMAT("Kppa: Integrating ",I8," grid cells, time interval [",E8.2,",",E8.2,"]")
    ...
    idata(4) = 4       ! Rodas3 Rosenbrock method
...
!-----------------------------------------------------------------------------
  SUBROUTINE InitMonitor(step)
    ...
    REAL(8), INTENT(IN) :: step
        ...
        WRITE(*,401)
        WRITE(*,402) "O1D","O","O3","NO","NO2","O2"
        WRITE(*,401)
401     FORMAT(123("-"))
402     FORMAT("       |     T     |     H     | Err. Norm | ",30(A11," |"))
...
!-----------------------------------------------------------------------------
  SUBROUTINE LookAt(step, err)
    ...
    WRITE(lookatFile,900) data
900 FORMAT(E24.16,E24.16,E24.16,1000(1X,E24.16))
