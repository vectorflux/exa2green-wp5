...
/* @author charlesj                                                            */
/* @date 2014-05-23 12:33:14.508430                                            */
    ...
    double const  reltol[82], int idata[20], double rdata[20], double* d_temp)
{
	...
	CHI=3.141592/180.*CHI;
        ...
        Rates(ncells32, T, idx, d_temp, d_rct, CHI);
        ...
        if (!autonomous) {
            ...
            Rates(ncells32, T+delta, idx, d_temp, d_rct, CHI);
        ...
        do {
            ...
            for (int i=1; i<nStage; ++i) {
                ...
                if (F[i]) {
                    ...
                    if(!autonomous) {
                      Rates(ncells32, tau, idx, d_temp, d_rct, CHI);
                    }
    ...
    /* printf("Cell %zu: elapsed time (timestep): %f \n", idx, finish-start); */
